...
<template>
    <div id="home">
        <div id="img">
            <img src="public/img/imagem_ia.jpg" alt="Imagem Perfil">
        </div>
        <div id="apresentacao">
            <h1 class="titulo-l texto-gradiente">SPARDEV</h1>
            <div id="subtitulo">
                <h3 class="subtitulo-m">Desenvolvedor</h3>
                <div id="bolinha"></div>
                <h3 class="subtitulo-m">Web</h3>
            </div>
        </div>
        <div id="icones">
